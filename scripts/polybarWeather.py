...
parser.add_argument(
    "-z", type=str, metavar="\tzipcode: is used with country_code", dest="zip_code"
)
parser.add_argument(
    "-c", type=str, metavar="\tcountrycode(lowerCase): tr,us,uk...", dest="country_code"
)
parser.add_argument(
    "-a",
    type=str,
...
parser.add_argument(
    "-t", type=str, metavar="\tOutput Type: Celcius, Fahrenheit, Kelvin", dest="o_type"
)
...
if __name__ == "__main__":
    ...
    if o_type_ is not None:
        ...
        print("⛅ " + degreeType(temp, o_type_))
    else:
        # print(weather + " " + str(temp - 273) + "°C")
        print("⛅ " + str(temp - 273) + "°C")
